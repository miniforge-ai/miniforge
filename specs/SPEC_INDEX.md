...
- **0.7.0-draft** (2026-04-23) - Fleet enablement amendments: closes 8 OSS spec gaps required for
  Fleet N10/N11/N12 MCI. N1 adds Pack Signature Format (§2.10.4.1), Pack Bundle Format (§2.10.6),
  Tool Registry (§2.31), Tenant (§2.32) with tenant-id propagated to Workflow/Pack Run schemas;
  N3 expands Streaming Protocol (§5.3) with auth/resume/listener-handshake/backpressure and adds
  tenant-id to event envelope; N6 registers :pr-context-pack artifact type and adds tenant-id to
  evidence bundles and artifacts; N8 adds Checkpoint Control (§3.1.5) and Model Control (§3.1.6)
  with corresponding events; N9 registers :pr-context-pack emission from ingestion; N11 hoists
  the TaskExecutor Protocol to normative (§10) with persist-workspace! / restore-workspace! and
  workspace-digest. Per-spec bumps: N1 0.5→0.6, N3 0.7→0.8, N6 0.5→0.6, N8 0.2→0.3, N9 0.1→0.2,
  N11 0.1→0.2
