...
(deftest ^{:stratum 0} slugify-uses-message-defaults
  (testing "nil input falls back to the configured default slug seed"
    (is (= "change" (metadata/slugify nil)))))

(deftest ^{:stratum 0} fallback-release-metadata-renders-resource-backed-body
...
(deftest ^{:stratum 0} fallback-release-metadata-uses-default-description
...
(deftest ^{:stratum 0} fallback-release-metadata-with-review-artifacts
...
(deftest ^{:stratum 0} format-known-issues-renders-structured-warnings-test
...
(deftest ^{:stratum 0} format-known-issues-renders-legacy-string-warnings-test
...
(deftest ^{:stratum 0} format-known-issues-empty-test
  (testing "nil/empty warnings → nil (no section)"
    (is (nil? (metadata/format-known-issues [])))
    (is (nil? (metadata/format-known-issues nil)))))

(deftest ^{:stratum 0} fallback-release-metadata-with-structured-warnings-test
...
(deftest ^{:stratum 0} fallback-release-metadata-with-legacy-string-warnings-test
...
(deftest ^{:stratum 0} fallback-release-metadata-with-failed-gates
...
(deftest ^{:stratum 0} fallback-release-metadata-without-workflow-data
...
(deftest ^{:stratum 0} fallback-title-smart-truncation
...
(deftest ^{:stratum 0} extract-review-artifacts-filters-correctly
...
(deftest ^{:stratum 0} extract-test-artifacts-filters-correctly
...
(deftest ^{:stratum 0} invoke-releaser-threads-behavior-addendum-from-context
...
(deftest ^{:stratum 0} invoke-releaser-omits-behavior-addendum-when-absent
