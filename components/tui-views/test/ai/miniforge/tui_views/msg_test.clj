...
;; ---------------------------------------------------------------------------- Helpers
(defn ^{:stratum 0} msg-type [msg] (first msg))

(defn ^{:stratum 0} msg-payload [msg] (second msg))

;; ---------------------------------------------------------------------------- Invariant: all messages are [keyword map] vectors
(deftest ^{:stratum 0} all-messages-are-keyword-map-vectors-test
...
;; Side-effect result messages
(deftest ^{:stratum 1} prs-synced-test
...
(deftest ^{:stratum 1} prs-synced-with-cache-test
...
(deftest ^{:stratum 1} repos-discovered-test
...
(deftest ^{:stratum 1} repos-browsed-test
...
(deftest ^{:stratum 1} policy-evaluated-test
...
(deftest ^{:stratum 1} train-created-test
...
(deftest ^{:stratum 1} decomposition-started-test
...
(deftest ^{:stratum 1} pr-diff-fetched-test
...
(deftest ^{:stratum 1} chat-response-test
...
;; Event stream translation messages
(deftest ^{:stratum 1} workflow-added-msg-test
...
(deftest ^{:stratum 1} agent-status-msg-test
...
(deftest ^{:stratum 1} agent-output-msg-test
...
(deftest ^{:stratum 1} chain-started-msg-test
...
(deftest ^{:stratum 1} chain-step-started-msg-test
