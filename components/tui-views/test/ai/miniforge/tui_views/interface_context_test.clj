...
;; ---------------------------------------------------------------------------- format-check-context
(deftest ^{:stratum 0} format-check-context-test
...
(deftest ^{:stratum 0} build-pr-context-str-minimal-pr-test
...
(deftest ^{:stratum 0} build-pr-context-str-nil-test
  (testing "returns nil for nil input"
    (is (nil? (iface/build-pr-context-str nil)))))

(deftest ^{:stratum 0} build-pr-context-str-behind-main-false-test
...
(deftest ^{:stratum 0} build-pr-context-str-failed-policy-test
...
(deftest ^{:stratum 0} build-pr-context-str-gitlab-provider-test
...
(deftest ^{:stratum 0} build-pr-context-str-zero-additions-test
...
(deftest ^{:stratum 0} build-pr-context-str-no-author-test
...
(deftest ^{:stratum 0} build-pr-context-str-risk-without-score-test
...
;; ---------------------------------------------------------------------------- build-context-section
(deftest ^{:stratum 0} build-context-section-pr-detail-test
...
(deftest ^{:stratum 0} build-context-section-pr-fleet-test
...
(deftest ^{:stratum 0} build-context-section-unknown-type-test
  (testing "returns unknown context for unrecognized type"
    (is (= "Unknown context."
           (#'iface/build-context-section {:type :unknown})))))

;; ---------------------------------------------------------------------------- build-chat-system-prompt
(deftest ^{:stratum 0} build-chat-system-prompt-test
...
;; ---------------------------------------------------------------------------- handle-chat-execute-action routing
(deftest ^{:stratum 0} handle-chat-execute-action-sync-test
...
(deftest ^{:stratum 0} handle-chat-execute-action-review-with-pr-test
...
(deftest ^{:stratum 0} handle-chat-execute-action-review-no-pr-test
...
(deftest ^{:stratum 0} handle-chat-execute-action-open-with-url-test
...
(deftest ^{:stratum 0} handle-chat-execute-action-open-no-url-test
...
(deftest ^{:stratum 0} handle-chat-execute-action-unknown-test
...
(deftest ^{:stratum 0} handle-chat-execute-action-exception-test
...
(deftest ^{:stratum 0} handle-chat-execute-action-decompose-test
...
(deftest ^{:stratum 0} handle-chat-execute-action-evaluate-test
...
;; ---------------------------------------------------------------------------- dispatch-effect routing
(deftest ^{:stratum 0} dispatch-effect-routes-fetch-pr-diff-test
...
(deftest ^{:stratum 0} dispatch-effect-routes-sync-prs-test
...
(deftest ^{:stratum 0} parse-actions-preserves-surrounding-text-test
...
(deftest ^{:stratum 0} parse-risk-line-level-case-insensitive-test
...
(deftest ^{:stratum 0} parse-risk-line-non-numeric-pr-number-test
  (testing "returns nil when PR number is not numeric"
    (is (nil? (iface/parse-risk-line "RISK: owner/repo#abc | high | reason")))))

(deftest ^{:stratum 0} parse-risk-line-repo-with-org-slashes-test
...
(deftest ^{:stratum 0} format-pr-summary-line-with-special-chars-test
...
;; ---------------------------------------------------------------------------- chat-msg->llm-msg
(deftest ^{:stratum 0} chat-msg->llm-msg-assistant-test
...
(deftest ^{:stratum 1} build-pr-context-str-full-pr-test
