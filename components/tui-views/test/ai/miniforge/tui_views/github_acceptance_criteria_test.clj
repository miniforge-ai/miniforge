...
(deftest ^{:stratum 0} ac1-namespace-exists-test
  (testing "the github namespace is loadable"
    (is (some? (find-ns 'ai.miniforge.tui-views.persistence.github)))))

(deftest ^{:stratum 0} ac1-fetch-pr-diff-and-detail-is-public-test
...
(deftest ^{:stratum 0} ac2-composite-calls-both-test
...
(deftest ^{:stratum 0} ac3-return-map-has-four-keys-test
...
(deftest ^{:stratum 0} ac3-diff-is-string-on-success-test
...
(deftest ^{:stratum 0} ac3-detail-is-map-on-success-test
...
(deftest ^{:stratum 0} ac3-no-exceptions-on-failure-test
...
(deftest ^{:stratum 0} ac3-partial-failure-preserves-success-test
...
(deftest ^{:stratum 0} ac4-handle-fetch-pr-diff-wires-to-msg-test
...
(deftest ^{:stratum 0} ac4-handle-fetch-pr-diff-total-failure-sets-error-test
...
(deftest ^{:stratum 0} ac4-handle-fetch-pr-diff-exception-caught-test
...
(deftest ^{:stratum 0} ac4-dispatch-effect-routes-to-handler-test
...
(deftest ^{:stratum 0} ac4-msg-pr-diff-fetched-contract-test
...
(deftest ^{:stratum 1} ac2-fetch-pr-diff-calls-gh-pr-diff-test
...
(deftest ^{:stratum 1} ac2-fetch-pr-detail-calls-gh-pr-view-json-test
