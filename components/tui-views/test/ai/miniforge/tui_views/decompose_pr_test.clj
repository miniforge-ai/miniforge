...
(def ^{:stratum 0} ^:private sample-detail
...
(defn- ^{:stratum 1} mock-decompose-success
...
(defn- ^{:stratum 1} mock-github-success
...
(deftest ^{:stratum 1} handle-decompose-pr-both-fetches-nil-test
...
(deftest ^{:stratum 1} handle-decompose-pr-diff-nil-detail-present-test
...
(deftest ^{:stratum 1} handle-decompose-pr-detail-nil-diff-present-test
...
(deftest ^{:stratum 1} handle-decompose-pr-decompose-fn-not-found-test
...
(deftest ^{:stratum 1} handle-decompose-pr-exception-in-github-fetch-test
...
(deftest ^{:stratum 1} handle-decompose-pr-no-exception-leaks-test
...
;; ---------------------------------------------------------------------------- PR-ID construction
(deftest ^{:stratum 1} handle-decompose-pr-id-is-repo-number-tuple-test
...
(deftest ^{:stratum 1} handle-decompose-pr-detail-with-no-files-key-test
...
(deftest ^{:stratum 1} handle-fetch-pr-diff-success-test
...
(deftest ^{:stratum 1} handle-fetch-pr-diff-both-nil-test
...
(deftest ^{:stratum 1} handle-fetch-pr-diff-exception-test
...
(deftest ^{:stratum 1} handle-fetch-pr-diff-string-number-coercion-test
...
(deftest ^{:stratum 2} handle-decompose-pr-fetches-diff-and-detail-test
...
(deftest ^{:stratum 2} handle-decompose-pr-extracts-changed-files-from-detail-test
...
(deftest ^{:stratum 2} handle-decompose-pr-calls-decompose-with-pr-and-diff-test
...
(deftest ^{:stratum 2} handle-decompose-pr-success-returns-plan-test
...
(deftest ^{:stratum 2} handle-decompose-pr-success-has-sub-prs-test
...
(deftest ^{:stratum 2} handle-decompose-pr-success-plan-has-expected-fields-test
...
(deftest ^{:stratum 2} handle-decompose-pr-no-longer-returns-stub-message-test
...
(deftest ^{:stratum 2} handle-decompose-pr-decompose-returns-error-test
...
(deftest ^{:stratum 2} handle-decompose-pr-decompose-returns-parse-error-test
...
(deftest ^{:stratum 2} handle-decompose-pr-exception-in-decompose-fn-test
...
(deftest ^{:stratum 2} handle-decompose-pr-uses-injected-decompose-fn-test
...
(deftest ^{:stratum 2} handle-decompose-pr-error-without-message-test
...
(deftest ^{:stratum 2} dispatch-effect-routes-decompose-pr-test
