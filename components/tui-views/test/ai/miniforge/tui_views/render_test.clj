...
(def ^{:stratum 0} ^:private size [80 24])

;------------------------------------------------------------------------------ Layer 1

(defn ^{:stratum 1} render-first-line
...
(deftest ^{:stratum 1} workflow-list-empty-state-is-actionable
...
(deftest ^{:stratum 1} workflow-list-renders-dated-workflows-without-throwing
...
(deftest ^{:stratum 2} top-level-views-have-distinct-tab-bars
...
(deftest ^{:stratum 2} pr-fleet-and-workflow-list-differ
