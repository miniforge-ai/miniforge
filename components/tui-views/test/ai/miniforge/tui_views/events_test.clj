...
;; ---------------------------------------------------------------------------- Helpers
(defn ^{:stratum 0} fresh [] (model/init-model))

(defn ^{:stratum 0} with-workflow
...
(deftest ^{:stratum 0} update-phase-status-test
...
(deftest ^{:stratum 0} normalize-artifact-test
...
(deftest ^{:stratum 0} apply-phase-completion-test
...
(deftest ^{:stratum 0} apply-workflow-completion-test
...
(deftest ^{:stratum 0} apply-evidence-intent-test
...
;; ---------------------------------------------------------------------------- Workflow events
(deftest ^{:stratum 1} handle-workflow-added-test
...
(deftest ^{:stratum 1} handle-workflow-added-upserts-existing-row-test
...
(deftest ^{:stratum 1} handle-workflow-added-uses-spec-name-test
...
(deftest ^{:stratum 1} handle-phase-changed-test
...
(deftest ^{:stratum 1} handle-phase-changed-updates-detail-test
...
(deftest ^{:stratum 1} handle-phase-done-test
...
(deftest ^{:stratum 1} handle-phase-done-caps-at-100-test
...
(deftest ^{:stratum 1} handle-workflow-done-test
...
(deftest ^{:stratum 1} handle-workflow-failed-test
...
;; ---------------------------------------------------------------------------- Agent events
(deftest ^{:stratum 1} handle-agent-status-test
...
(deftest ^{:stratum 1} handle-agent-output-test
...
(deftest ^{:stratum 1} handle-agent-output-ignores-non-active-detail-test
...
(deftest ^{:stratum 1} handle-agent-started-test
...
(deftest ^{:stratum 1} handle-agent-completed-test
...
(deftest ^{:stratum 1} handle-agent-failed-test
...
;; ---------------------------------------------------------------------------- Gate events
(deftest ^{:stratum 1} handle-gate-result-passing-test
...
(deftest ^{:stratum 1} handle-gate-result-failing-test
...
(deftest ^{:stratum 1} handle-gate-started-test
...
(deftest ^{:stratum 1} handle-gate-started-nil-gate-test
...
;; ---------------------------------------------------------------------------- Tool events
(deftest ^{:stratum 1} handle-tool-invoked-test
...
(deftest ^{:stratum 1} handle-tool-completed-test
...
(deftest ^{:stratum 1} handle-tool-nil-agent-test
...
;; ---------------------------------------------------------------------------- PR events
(deftest ^{:stratum 1} handle-prs-synced-test
...
(deftest ^{:stratum 1} handle-prs-synced-refreshes-active-detail-and-filter-test
...
(deftest ^{:stratum 1} handle-prs-synced-empty-test
...
(deftest ^{:stratum 1} handle-prs-synced-nil-test
  (testing "nil pr-items treated as empty"
    (let [m (events/handle-prs-synced (fresh) {:pr-items nil})]
      (is (empty? (:pr-items m))))))

(deftest ^{:stratum 1} handle-policy-evaluated-passed-test
...
(deftest ^{:stratum 1} handle-policy-evaluated-failed-test
...
(deftest ^{:stratum 1} handle-policy-evaluated-error-test
...
(deftest ^{:stratum 1} handle-policy-evaluated-updates-detail-test
...
;; ---------------------------------------------------------------------------- Train events
(deftest ^{:stratum 1} handle-train-created-test
...
(deftest ^{:stratum 1} handle-prs-added-to-train-test
...
(deftest ^{:stratum 1} handle-repos-discovered-failure-test
  (testing "failure path shows error"
    (let [m (events/handle-repos-discovered (fresh)
              {:success? false :error "auth failed"})]
      (is (str/includes? (:flash-message m) "failed")))))

(deftest ^{:stratum 1} handle-repos-browsed-success-test
...
(deftest ^{:stratum 1} handle-repos-browsed-failure-test
...
(deftest ^{:stratum 1} handle-repos-browsed-no-error-detail-test
...
(deftest ^{:stratum 1} handle-repos-browsed-repo-manager-source-test
...
;; ---------------------------------------------------------------------------- Chat events
(deftest ^{:stratum 1} handle-chat-response-test
...
(deftest ^{:stratum 1} handle-chat-response-nil-content-test
...
(deftest ^{:stratum 1} handle-chat-action-result-test
...
(deftest ^{:stratum 1} unknown-workflow-id-is-noop-test
...
(deftest ^{:stratum 1} known-workflow-not-duplicated-test
...
;; ---------------------------------------------------------------------------- PR update/remove
(deftest ^{:stratum 1} handle-pr-updated-test
...
(deftest ^{:stratum 1} handle-pr-removed-test
...
(deftest ^{:stratum 1} handle-prs-synced-applies-cached-risk-test
...
(deftest ^{:stratum 1} handle-prs-synced-triggers-batch-policy-eval-test
...
(deftest ^{:stratum 1} handle-prs-synced-triggers-risk-triage-test
  (testing "new PRs trigger fleet-risk-triage side-effect"
    (let [prs [{:pr/repo "r1" :pr/number 1 :pr/title "t1"}]
          m (events/handle-prs-synced (fresh) {:pr-items prs})]
      (is (some #(= :fleet-risk-triage (:type %)) (:side-effects m))))))

(deftest ^{:stratum 1} handle-prs-synced-skips-triage-when-hash-unchanged-test
...
(deftest ^{:stratum 1} handle-prs-synced-error-test
...
(deftest ^{:stratum 1} handle-policy-evaluated-emits-cache-side-effect-test
...
(deftest ^{:stratum 1} handle-fleet-risk-triaged-emits-cache-side-effect-test
...
;; ---------------------------------------------------------------------------- ensure-workflow
(deftest ^{:stratum 1} ensure-workflow-test
