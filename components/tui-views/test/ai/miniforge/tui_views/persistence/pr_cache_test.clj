...
;; ---------------------------------------------------------------------------
;; read-cache / write-cache! roundtrip
;; ---------------------------------------------------------------------------
(deftest ^{:stratum 1} read-cache-nonexistent-test
...
(deftest ^{:stratum 1} write-read-roundtrip-test
...
;; ---------------------------------------------------------------------------
(deftest ^{:stratum 1} persist-policy-result!-test
...
;; persist-risk-triage!
;; ---------------------------------------------------------------------------
(deftest ^{:stratum 1} persist-risk-triage!-test
...
(deftest ^{:stratum 2} entry-valid?-test
...
;; apply-cached-policy
;; ---------------------------------------------------------------------------
(deftest ^{:stratum 2} apply-cached-policy-test
...
;; ---------------------------------------------------------------------------
;; apply-cached-agent-risk
;; ---------------------------------------------------------------------------
(deftest ^{:stratum 2} apply-cached-agent-risk-test
