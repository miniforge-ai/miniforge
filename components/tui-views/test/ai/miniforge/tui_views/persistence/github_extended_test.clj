...
;; ---------------------------------------------------------------------------- Precondition tests
(deftest ^{:stratum 0} fetch-pr-diff-precondition-test
...
(deftest ^{:stratum 0} fetch-pr-detail-precondition-test
  (testing "throws AssertionError when repo is not a string"
...
(deftest ^{:stratum 0} fetch-pr-diff-and-detail-precondition-test
  (testing "throws AssertionError when repo is not a string"
...
(deftest ^{:stratum 0} coerce-number-via-composite-test
...
(deftest ^{:stratum 0} coerce-number-invalid-string-test
...
;; ---------------------------------------------------------------------------- Concurrency
(deftest ^{:stratum 0} fetch-pr-diff-and-detail-concurrency-test
...
(deftest ^{:stratum 0} fetch-pr-diff-and-detail-one-slow-does-not-block-other-test
...
(deftest ^{:stratum 0} no-cli-base-dependency-test
...
(deftest ^{:stratum 0} fetch-pr-diff-and-detail-return-shape-test
...
(deftest ^{:stratum 1} fetch-pr-diff-whitespace-test
...
(deftest ^{:stratum 1} fetch-pr-detail-nested-labels-test
...
(deftest ^{:stratum 1} fetch-pr-detail-empty-body-test
...
(deftest ^{:stratum 1} fetch-pr-detail-files-field-present-test
...
(deftest ^{:stratum 1} fetch-pr-detail-multiple-files-test
...
;; ---------------------------------------------------------------------------- Various exit codes
(deftest ^{:stratum 1} fetch-pr-diff-various-exit-codes-test
...
(deftest ^{:stratum 1} fetch-pr-detail-various-exit-codes-test
...
(deftest ^{:stratum 1} fetch-pr-diff-cli-args-test
...
(deftest ^{:stratum 1} fetch-pr-detail-cli-args-test
...
(deftest ^{:stratum 1} fetch-pr-diff-return-type-test
...
(deftest ^{:stratum 1} fetch-pr-detail-return-type-test
