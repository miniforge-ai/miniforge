...
;; ---------------------------------------------------------------------------- Helpers
(defn ^{:stratum 0} mock-shell-success
  "Return a mock shell result that looks like a successful process."
  [out]
  {:exit 0 :out out :err ""})

(defn ^{:stratum 0} mock-shell-failure
...
(deftest ^{:stratum 0} fetch-pr-diff-exception-test
...
(deftest ^{:stratum 0} fetch-pr-diff-nil-out-test
...
(deftest ^{:stratum 0} fetch-pr-diff-and-detail-success-test
...
(deftest ^{:stratum 0} fetch-pr-diff-and-detail-string-number-coercion-test
...
(deftest ^{:stratum 0} fetch-pr-diff-and-detail-int-number-test
...
(deftest ^{:stratum 0} fetch-pr-diff-and-detail-partial-failure-test
...
(deftest ^{:stratum 0} fetch-pr-diff-and-detail-both-fail-test
...
(deftest ^{:stratum 0} fetch-pr-diff-and-detail-return-shape-invariant-test
...
(deftest ^{:stratum 0} fetch-pr-diff-and-detail-number-type-invariant-test
...
(deftest ^{:stratum 0} fetch-pr-diff-and-detail-repo-passthrough-invariant-test
...
;; ---------------------------------------------------------------------------- fetch-pr-diff
(deftest ^{:stratum 1} fetch-pr-diff-success-test
...
(deftest ^{:stratum 1} fetch-pr-diff-string-number-test
...
(deftest ^{:stratum 1} fetch-pr-diff-whitespace-trimming-test
...
(deftest ^{:stratum 1} fetch-pr-detail-success-test
...
(deftest ^{:stratum 1} fetch-pr-detail-empty-json-object-test
...
(deftest ^{:stratum 1} fetch-pr-detail-passes-json-fields-arg-test
