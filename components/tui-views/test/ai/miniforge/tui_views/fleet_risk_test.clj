...
;; ---------------------------------------------------------------------------- repo-from-pr-url
(deftest ^{:stratum 0} repo-from-pr-url-test
...
(deftest ^{:stratum 0} assessments->risk-map-test
...
(deftest ^{:stratum 0} find-linked-workflow-test
...
(deftest ^{:stratum 0} find-workflow-by-id-test
  (let [id1 (random-uuid)
        id2 (random-uuid)
...
(deftest ^{:stratum 0} workflow-matches-branch-test
...
;; ---------------------------------------------------------------------------- Prompt templates
(deftest ^{:stratum 0} prompt-templates-load-test
...
;; ---------------------------------------------------------------------------- Schema validation
(deftest ^{:stratum 0} schema-defs-exist-test
...
;; ---------------------------------------------------------------------------- index-workflow-pr
(deftest ^{:stratum 1} index-workflow-pr-test
  (let [wf-id (random-uuid)]
...
(deftest ^{:stratum 1} annotate-pr-with-workflow-test
  (let [wf-id (random-uuid)
...
(deftest ^{:stratum 1} handle-workflow-done-stores-pr-info-test
  (let [wf-id (random-uuid)
...
(deftest ^{:stratum 1} handle-prs-synced-annotates-workflow-linked-prs-test
  (let [wf-id (random-uuid)
        m (-> (fresh)
...
(deftest ^{:stratum 1} handle-fleet-risk-triaged-test
...
(deftest ^{:stratum 1} build-pr-summary-for-triage-test
...
;; ---------------------------------------------------------------------------- pr-triage-summary
(deftest ^{:stratum 1} pr-triage-summary-test
