...
(deftest ^{:stratum 0} mode-switching-test
...
(deftest ^{:stratum 0} train-view-navigation-test
...
(deftest ^{:stratum 0} repo-manager-actions-test
...
;; ---------------------------------------------------------------------------
(deftest ^{:stratum 0} search-mode-mapped-letters-test
...
(deftest ^{:stratum 0} workflow-detail-scroll-test
...
;; ---------------------------------------------------------------------------
(deftest ^{:stratum 0} pr-synced-test
...
(deftest ^{:stratum 0} repos-browsed-test
...
(deftest ^{:stratum 0} pr-updated-test
...
(deftest ^{:stratum 0} pr-removed-test
...
(deftest ^{:stratum 0} side-effect-error-test
...
;; ---------------------------------------------------------------------------
(deftest ^{:stratum 0} pr-detail-right-arrow-triggers-side-effects-test
...
(deftest ^{:stratum 1} workflow-events-test
...
(deftest ^{:stratum 1} gate-result-event-test
...
(deftest ^{:stratum 1} pr-navigation-test
...
(deftest ^{:stratum 1} tab-navigation-test
...
(deftest ^{:stratum 1} shift-tab-navigation-test
...
(deftest ^{:stratum 1} sync-command-sets-side-effect-test
...
(deftest ^{:stratum 2} view-navigation-test
...
;; ---------------------------------------------------------------------------
(deftest ^{:stratum 2} new-keybinding-test
...
(deftest ^{:stratum 2} help-overlay-dismissal-test
...
;; ---------------------------------------------------------------------------
(deftest ^{:stratum 2} tab-after-go-back-regression-test
...
;; ---------------------------------------------------------------------------
(deftest ^{:stratum 2} detail-sibling-navigation-test
...
(deftest ^{:stratum 2} batch-archive-test
...
(deftest ^{:stratum 2} batch-delete-test
...
(deftest ^{:stratum 2} batch-cancel-test
...
(deftest ^{:stratum 2} batch-rerun-test
...
;; ---------------------------------------------------------------------------
(deftest ^{:stratum 2} enter-workflow-detail-fires-reload-side-effect-test
...
;; ---------------------------------------------------------------------------
(deftest ^{:stratum 2} workflow-detail-loaded-test
