...
;; ---------------------------------------------------------------------------
(defn ^{:stratum 0} detail-model-with-output
...
(deftest ^{:stratum 0} evidence-search-test
...
(deftest ^{:stratum 1} workflow-detail-search-test
...
(deftest ^{:stratum 1} workflow-detail-confirm-search-test
...
(deftest ^{:stratum 1} search-match-navigation-test
...
(deftest ^{:stratum 1} search-match-navigation-via-keys-test
...
(deftest ^{:stratum 1} escape-clears-search-matches-test
...
(deftest ^{:stratum 2} search-filtering-test
...
(deftest ^{:stratum 2} search-mode-escape-test
...
(deftest ^{:stratum 2} search-resets-selection-test
...
;; ---------------------------------------------------------------------------
(deftest ^{:stratum 2} search-confirm-keeps-filter-test
