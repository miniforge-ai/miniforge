...
(defn ^{:stratum 0} pane-detail-view?
  "Views where j/k should navigate per-pane selection."
  [view]
  (= :pr-detail view))

(defn ^{:stratum 0} pane-count
...
(defn ^{:stratum 1} pane-navigate-up
...
(defn ^{:stratum 1} cycle-pane-reverse
