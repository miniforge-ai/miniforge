...
;; format-sync-time
;; ============================================================================
(deftest ^{:stratum 0} format-sync-time-valid-date-test
...
(deftest ^{:stratum 0} format-sync-time-nil-test
  (testing "Returns nil for nil timestamp"
    (is (nil? (sut/format-sync-time nil)))))

(deftest ^{:stratum 0} format-sync-time-invalid-input-test
...
;; ============================================================================
(deftest ^{:stratum 0} fleet-action-onclick-all-actions-test
...
(deftest ^{:stratum 0} fleet-action-onclick-unknown-action-test
...
;; ============================================================================
(deftest ^{:stratum 0} error-category-variant-all-categories-test
...
(deftest ^{:stratum 0} error-category-variant-unknown-test
...
;; ============================================================================
(deftest ^{:stratum 0} readiness-state-label-unknown-keyword-test
  (testing "Unknown keyword returns its name"
    (is (= "some-state" (sut/readiness-state-label :some-state)))))

(deftest ^{:stratum 0} readiness-state-label-nil-test
...
;; ============================================================================
(deftest ^{:stratum 0} readiness-state-variant-unknown-keyword-test
...
;; ============================================================================
(deftest ^{:stratum 0} error-category-label-unknown-keyword-test
  (testing "Unknown keyword returns its name"
    (is (= "weird-cat" (sut/error-category-label :weird-cat)))))

(deftest ^{:stratum 0} error-category-label-nil-test
...
;; sync-failure-entry
;; ============================================================================
(deftest ^{:stratum 2} sync-failure-entry-full-test
...
(deftest ^{:stratum 2} sync-failure-entry-no-category-test
...
(deftest ^{:stratum 2} sync-failure-entry-blank-action-test
...
;; ============================================================================
(deftest ^{:stratum 2} sync-status-fragment-nil-test
...
(deftest ^{:stratum 2} sync-status-fragment-failed-status-test
...
;; train-detail-view error case
;; ============================================================================
(deftest ^{:stratum 2} train-detail-view-error-test
...
(deftest ^{:stratum 2} train-detail-view-no-prs-test
...
;; ============================================================================
(deftest ^{:stratum 2} blocking-reason-line-all-types-test
...
(deftest ^{:stratum 2} blocking-reason-line-no-message-test
...
;; ============================================================================
(deftest ^{:stratum 2} pr-readiness-fragment-no-score-test
...
(deftest ^{:stratum 2} pr-readiness-fragment-zero-score-test
...
(deftest ^{:stratum 2} pr-readiness-fragment-perfect-score-test
