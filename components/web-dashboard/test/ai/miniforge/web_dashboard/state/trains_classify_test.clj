...
;; gh-error-message
;; ============================================================================
(deftest ^{:stratum 0} gh-error-message-prefers-err-test
...
(deftest ^{:stratum 0} gh-error-message-nil-handling-test
...
;; train-name-for-repo
;; ============================================================================
(deftest ^{:stratum 0} train-name-for-repo-test
...
;; prs->status-map
;; ============================================================================
(deftest ^{:stratum 0} prs->status-map-test
...
;; pr-ready?
;; ============================================================================
(deftest ^{:stratum 0} pr-ready?-fully-ready-test
...
(deftest ^{:stratum 0} pr-ready?-no-deps-test
...
(deftest ^{:stratum 0} pr-ready?-ci-failed-test
...
(deftest ^{:stratum 0} pr-ready?-behind-main-test
  (testing "PR behind main is not ready"
    (let [pm {1 {:pr/number 1 :pr/status :approved :pr/ci-status :passed
                 :pr/behind-main? true}}]
      (is (false? (sut/pr-ready? pm (get pm 1)))))))

(deftest ^{:stratum 0} pr-ready?-unresolved-deps-test
...
(deftest ^{:stratum 0} pr-ready?-open-status-test
...
(deftest ^{:stratum 0} pr-ready?-failed-gates-test
...
;; ============================================================================
(deftest ^{:stratum 0} readiness-factors-structure-test
...
(deftest ^{:stratum 0} readiness-factors-all-perfect-test
...
(deftest ^{:stratum 0} readiness-factors-all-bad-test
...
;; readiness-summary
;; ============================================================================
(deftest ^{:stratum 0} readiness-summary-test
...
(deftest ^{:stratum 0} readiness-summary-empty-test
  (testing "Empty PR list returns empty map"
    (is (= {} (sut/readiness-summary [])))))

(deftest ^{:stratum 0} readiness-summary-missing-readiness-test
...
;; blocking-details
;; ============================================================================
(deftest ^{:stratum 0} blocking-details-test
...
(deftest ^{:stratum 0} blocking-details-missing-pr-test
...
(deftest ^{:stratum 0} blocking-details-empty-test
...
;; enrich-pr composite
;; ============================================================================
(deftest ^{:stratum 0} enrich-pr-adds-all-keys-test
...
(deftest ^{:stratum 0} enrich-pr-blocking-reasons-match-blockers-test
...
;; ============================================================================
(deftest ^{:stratum 0} readiness-state-priority-ci-over-dep-blocked-test
...
(deftest ^{:stratum 0} readiness-state-priority-changes-requested-over-dep-blocked-test
...
(deftest ^{:stratum 0} readiness-state-priority-dep-blocked-over-merge-conflicts-test
...
(deftest ^{:stratum 0} readiness-state-priority-merge-conflicts-over-policy-test
...
(deftest ^{:stratum 0} pr-map-empty-test
  (testing "Empty list returns empty map"
    (is (= {} (sut/pr-map [])))))
...
;; ============================================================================
(deftest ^{:stratum 0} readiness-threshold-sanity-test
  (testing "Threshold is between 0 and 1"
    (is (<= 0.0 sut/readiness-threshold 1.0))))

(deftest ^{:stratum 0} readiness-weights-sum-to-one-test
