...
(ns ai.miniforge.web-dashboard.state.fleet-test
  ...
  (:require
   ...
   [ai.miniforge.web-dashboard.state.fleet :as sut]))
...
;; ============================================================================
(deftest ^{:stratum 0} calculate-risk-score-zero-baseline-test
  (testing "Entity with no risk factors scores 0"
    (is (= 0 (sut/calculate-risk-score
              {:pr/ci-status :passed
               :pr/status :approved})))))

(deftest ^{:stratum 0} calculate-risk-score-ci-penalties-test
...
(deftest ^{:stratum 0} calculate-risk-score-status-penalties-test
...
(deftest ^{:stratum 0} calculate-risk-score-dependency-penalty-test
...
(deftest ^{:stratum 0} calculate-risk-score-blocking-penalty-test
...
(deftest ^{:stratum 0} calculate-risk-score-combined-factors-test
...
(deftest ^{:stratum 0} calculate-risk-score-capped-at-100-test
...
(deftest ^{:stratum 0} calculate-risk-score-nil-entity-test
  (testing "Empty/nil entity scores 0 (all defaults to zero)"
    (is (= 0 (sut/calculate-risk-score {})))
    (is (= 0 (sut/calculate-risk-score nil)))))

(deftest ^{:stratum 0} calculate-risk-score-alternate-key-forms-test
...
;; compute-stats tests
;; ============================================================================
(deftest ^{:stratum 0} compute-stats-empty-inputs-test
...
(deftest ^{:stratum 0} compute-stats-workflow-counts-test
...
;; ============================================================================
(deftest ^{:stratum 0} compute-risk-analysis-empty-test
...
(deftest ^{:stratum 1} compute-stats-single-healthy-train-test
...
(deftest ^{:stratum 1} compute-stats-mixed-trains-test
...
(deftest ^{:stratum 1} compute-stats-health-buckets-test
...
(deftest ^{:stratum 1} compute-risk-analysis-levels-test
...
(deftest ^{:stratum 1} compute-risk-analysis-summary-counts-test
...
(deftest ^{:stratum 1} compute-risk-analysis-factors-test
...
(deftest ^{:stratum 1} compute-risk-analysis-no-factors-for-healthy-test
  (testing "Healthy trains have no risk factors"
    (let [analysis (sut/compute-risk-analysis [healthy-train])
          factors (-> analysis :risks first :factors)]
      (is (empty? factors)))))

(deftest ^{:stratum 1} compute-risk-analysis-sorted-descending-test
