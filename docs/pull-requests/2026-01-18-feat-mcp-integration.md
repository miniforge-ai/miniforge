...
Adds MCP (Model Context Protocol) compatibility to the extensibility specification, enabling native agent integration with MCP-compatible clients (Claude Desktop, Cursor, etc.) without custom tool-calling logic.
