...
Add the `logging` component providing structured EDN logging capabilities. This component depends on `schema` for type
definitions and provides the logging infrastructure for all other components.
