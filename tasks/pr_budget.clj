  ...
  (let [entries   (pr-diff base-sha head-sha)
    ...
    (cond
      ...
      (do (println "")
          ...
          (println "  (The 600-line budget above is REPORTABLE lines -- after blank/")
          (println "  comment/generated-path exclusion. The numbers below are raw")
          (println "  changed lines, a different, larger count -- they're not directly")
          (println "  comparable to your total above.)")
